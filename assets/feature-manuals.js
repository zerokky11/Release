(function () {
  ...
  const features = [
    ...
    },
    {
      ...
      run: [
        '엑셀 기준 적용을 누르면 HostFileName과 TargetLinkPath 기준으로 링크를 수정합니다.',
  ...
  const manualDetailAdditions = {
    ...
    linkpath: {
      setupLead: '먼저 현재 링크 현황을 엑셀로 추출하고, 같은 엑셀에 대상 경로를 작성해 다시 적용합니다.',
      settingDetails: [
        {
          label: '대상 RVT',
        ...
        {
          label: '신규 링크 행',
          description: 'LinkName과 ReferenceElementId를 비우고 HostFileName, TargetLinkPath, 적용 웍셋을 채우면 새 Revit 링크로 생성합니다.',
          example: 'HostFileName=M-Main.rvt, TargetLinkPath=D:\\Links\\S-Main.rvt를 입력하고 링크 식별 열은 비워 둡니다.'
        },
        {
          label: '신규 링크 배치 방식',
          description: '원점 대 원점, 중심 대 중심, 공유 좌표, 프로젝트 기준점 중 신규 링크의 배치 기준을 선택합니다.',
          example: '프로젝트가 공유 좌표를 사용한다면 자동 - 공유 좌표 기준을 선택합니다.'
        }
      ],
      run: [
