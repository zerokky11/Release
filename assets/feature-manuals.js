(function () {
  const staticAssetVersion = '3.0-20260715.3';
  ...
  const features = [
    {
      ...
      setup: [
        ...
        'End + Dummy 패밀리 제외를 켜면 패밀리명에 End 또는 Dummy 성격의 이름이 들어간 요소를 검토 대상에서 제외합니다.',
      ...
      logic: [
        ...
        'End, Dummy 계열 제외 옵션이 켜져 있으면 해당 패밀리는 검토 대상에서 제외합니다.',
        '결과에는 파일, 요소, 연결 상대, 좌표, 선택 파라미터 값, 판정 문구가 포함됩니다.'
      ],
      result: [
        '오류 건수와 정상 건수를 기능 결과 카드에 표시합니다.',
        '엑셀에는 오류 행 중심으로 저장하며, 선택한 추가 옵션에 따라 좌표와 선형 정보 열이 추가됩니다.',
    ...
    connector: {
      ...
      settingDetails: [
        ...
        },
        {
          ...
          description: 'End 또는 Dummy 성격의 이름을 가진 패밀리를 연속성 검사에서 제외합니다.',
          example: 'PIPE_END, Dummy Cap 같은 종단용 패밀리를 정상 흐름에서 빼려면 켭니다.'
        },
        {
          label: '공통 설정',
  ...
  function getSetupScreens(feature) {
    ...
    if (selectableFeatureIds.has(feature.id)) {
      screens.push({
